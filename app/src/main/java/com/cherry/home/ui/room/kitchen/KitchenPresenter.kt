...
@ConfigPersistent
class KitchenPresenter @Inject constructor() : BasePresenter<KitchenView>(), DeviceUpdateEvent {

    private val TAG : String = "KitchenPresenter"
